...
class Blackbird2(object):
    """
    Monoprice blackbird2 amplifier interface
    """
...
def get_blackbird2(url, use_serial=True, ir_control=True):
    """
    Return synchronous version of Blackbird2 interface
    ...
    class Blackbird2Sync(Blackbird2):
        ...
        def _process_request(self, request: bytes, skip=0):
            """
            Send data to socket
            :param request: request that is sent to the blackbird2
            :param skip: number of bytes to skip for end of transmission decoding
            :return: ascii string returned by blackbird2
            """
